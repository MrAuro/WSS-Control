...
export class DiscordStrategy<User> extends OAuth2Strategy<User, DiscordProfile, DiscordExtraParams> {
	name = 'discord';
	...
	constructor(
		{ clientID, clientSecret, callbackURL, scope, prompt }: DiscordStrategyOptions,
		verify: StrategyVerifyCallback<User, OAuth2StrategyVerifyParams<DiscordProfile, DiscordExtraParams>>
	) {
		super(
			{
				clientID,
